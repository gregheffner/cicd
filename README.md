...
<img alt="Cloudflare Block" src="https://img.shields.io/badge/cloudflare--block-32-red?logo=cloudflare&style=for-the-badge">
<img alt="Cloudflare Cache Clear" src="https://img.shields.io/badge/Cloudflare%20Cache%20Clear-2025--06--11%2002:00%20UTC-orange?logo=cloudflare&style=for-the-badge">
...
| ![Cloudflare Credentials](https://img.shields.io/badge/Cloudflare%20Creds-yellow?logo=githubactions&style=for-the-badge) | Manages or updates Cloudflare credentials for deployments. | Manual & Push | [Run Workflow](../../actions/workflows/cloudflare-creds.yaml) |
...
| ![Deploy](https://img.shields.io/badge/Deploy-green?logo=githubactions&style=for-the-badge) | Deploys the application to the target environment. | Manual & Push | [Run Workflow](../../actions/workflows/deploy.yaml) |
